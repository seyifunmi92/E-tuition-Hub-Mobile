...
class Passss extends StatefulWidget {
  const Passss({super.key});

  @override
  State<Passss> createState() => _PassssState();
}

class _PassssState extends State<Passss> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(   backgroundColor: ethcolor.ethbkgd,
      body: Padding(
